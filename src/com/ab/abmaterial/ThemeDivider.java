...
public class ThemeDivider implements java.io.Serializable {
	private static final long serialVersionUID = 2545288090066652816L;
	...
	@Hide
	public ThemeDivider Clone() {
		ThemeDivider c = new ThemeDivider();
